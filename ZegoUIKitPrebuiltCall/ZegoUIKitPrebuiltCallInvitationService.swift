...
extension ZegoUIKitPrebuiltCallInvitationService: CallInvitationServiceApi {
    ...
    @objc public func initWithAppID(_ appID: UInt32, appSign: String, userID: String, userName: String, config: ZegoUIKitPrebuiltCallInvitationConfig, callback: ZegoCommonCallback?)
    {
...
//            try to enable voip if import
    ...
    @objc public func initWithAppID(_ appID: UInt32, appSign: String, userID: String, userName: String, callback: ZegoCommonCallback?) {
