...
public typealias ZegoCommonCallback = (_ errorCode: Int32, _ message: String) -> Void
...
public protocol CallInvitationServiceApi {
    ...
    func initWithAppID(_ appID: UInt32, appSign: String, userID: String, userName: String, config: ZegoUIKitPrebuiltCallInvitationConfig, callback: ZegoCommonCallback?)
    ...
    ///   - userID: User unique identification
    ///   - userName: userName
    func initWithAppID(_ appID: UInt32, appSign: String, userID: String, userName: String, callback: ZegoCommonCallback?)
