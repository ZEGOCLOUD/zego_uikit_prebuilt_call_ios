...
@objc public protocol ZegoUIKitPrebuiltCallInvitationServiceDelegate: AnyObject {
    ...
    @available(iOS, deprecated, message: "Use onIncomingCallReceived instead")
    @objc optional func onIncomingCallReceived(_ callID: String, caller: ZegoCallUser, callType: ZegoCallType, callees: [ZegoCallUser]?)
    
    @objc optional func onIncomingCallReceived(_ callID: String, caller: ZegoCallUser, callType: ZegoCallType, callees: [ZegoCallUser]?, customData: String)
