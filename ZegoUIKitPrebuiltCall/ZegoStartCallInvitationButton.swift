...
public class ZegoStartCallInvitationButton: ZegoStartInvitationButton {
    ...
    @objc override open func buttonClick() {
        ...
        self.data = ["call_id": callData.callID as AnyObject, "invitees": self.conversionInvitees() as AnyObject].call_jsonString
    ...
    func conversionInvitees() -> String {
        ...
        return newInvitees.call_convertArrayToString()
    }
