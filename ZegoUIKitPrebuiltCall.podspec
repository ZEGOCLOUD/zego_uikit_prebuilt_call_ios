...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of ZegoUIKitPrebuiltCall."
  ...
  spec.homepage     = "http://EXAMPLE/ZegoUIKitPrebuiltCall"
  ...
  spec.source       = { :git => "http://EXAMPLE/ZegoUIKitPrebuiltCall.git", :tag => "#{spec.version}" }
